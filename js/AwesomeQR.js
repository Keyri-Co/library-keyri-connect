let AwesomeQR = (function () {
  return (() => {
    var t = {
        154: (t, e, r) => {
          const o = r(342);
          e.parseFont = o, e.createCanvas = function (t, e) {
        ...
        342: t => {
          ...
          const e = "'([^']+)'|\"([^\"]+)\"|[\\w\\s-]+",
            ...
            a = new RegExp("([\\d\\.]+)(px|pt|pc|in|cm|mm|%|em|ex|ch|rem|q) *((?:" + e + ")( *, *(?:" + e + "))*)"),
            s = {};
          t.exports = function (t) {
            ...
            let u, h, c, f, d = t.substring(0, e.index);
            switch ((u = r.exec(d)) && (l.weight = u[1]), (h = o.exec(d)) && (l.style = h[1]), (c = n.exec(d)) && (l.variant = c[1]), (f = i.exec(d)) && (l.stretch = f[1]), l.unit) {
            case "pt":
              l.size /= .75;
              break;
            case "pc":
        ...
        662: (t, e) => {
          ...
          Object.defineProperty(e, "__esModule", {
            value: !0
          }), e.loop = e.conditional = e.parse = void 0, e.parse = function t(e, r) {
            var o = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {},
              n = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : o;
            if (Array.isArray(r)) r.forEach((function (r) {
              ...
              Array.isArray(r[i]) ? (n[i] = {}, t(e, r[i], o, n[i])) : n[i] = r[i](e, o, n, t)
            }
            return o
        ...
        58: (t, e) => {
          ...
          Object.defineProperty(e, "__esModule", {
            value: !0
          }), e.readBits = e.readArray = e.readUnsigned = e.readString = e.peekBytes = e.readBytes = e.peekByte = e.readByte = e.buildStream = void 0, e.buildStream = function (t) {
            return {
              data: t,
              pos: 0
            }
          ...
          e.readBytes = r, e.peekBytes = function (t) {
            return function (e) {
              return e.data.subarray(e.pos, e.pos + t)
            }
            ...
            return function (o, n, i) {
              for (var a = "function" == typeof e ? e(o, n, i) : e, s = r(t), l = new Array(a), u = 0; u < a; u++) l[u] = s(o);
              return l
            }
            ...
            return function (e) {
              for (var r = function (t) {
                  return t.data[t.pos++]
                }(e), o = new Array(8), n = 0; n < 8; n++) o[7 - n] = !!(r & 1 << n);
              return Object.keys(t).reduce((function (e, r) {
                var n = t[r];
                return n.length ? e[r] = function (t, e, r) {
                  for (var o = 0, n = 0; n < r; n++) o += t[e + n] && Math.pow(2, r - n - 1);
                  return o
                }(o, n.index, n.length) : e[r] = o[n.index], e
              }), {})
            }
          }
        },
        323: (t, e, r) => {
          ...
          var o = r(662),
            ...
            i = {
              blocks: function (t) {
                for (var e = [], r = t.data.length, o = 0, i = (0, n.readByte)()(t); 0 !== i; i = (0, n.readByte)()(t)) {
                  if (t.pos + i >= r) {
                    var a = r - t.pos;
                ...
                for (var s = new Uint8Array(o), l = 0, u = 0; u < e.length; u++) s.set(e[u], l), l += e[u].length;
                return s
              }
            },
            a = (0, o.conditional)({
            ...
            f = function () {
              function t(e) {
                ...
                if (Object.keys(t.defaultOptions).forEach((function (e) {
                  ...
                  })), r.components ? "object" == typeof r.components && Object.keys(t.defaultComponentOptions).forEach((function (e) {
                    e in r.components ? Object.defineProperty(r.components, e, {
                      value: o(o({}, t.defaultComponentOptions[e]), r.components[e]),
                      enumerable: !0,
                      writable: !0
                  ...
                  })) : r.components = t.defaultComponentOptions, null !== r.dotScale && void 0 !== r.dotScale) {
                ...
                this.options = r, this.canvas = s.createCanvas(e.size, e.size), this.canvasContext = this.canvas.getContext("2d"), this.qrCode = new u.QRCodeModel(-1, this.options.correctLevel), Number.isInteger(this.options.maskPattern) && (this.qrCode.maskPattern = this.options.maskPattern), Number.isInteger(this.options.version) && (this.qrCode.typeNumber = this.options.version), this.qrCode.addData(this.options.text), this.qrCode.make()
              }
              return t.prototype.draw = function () {
                ...
                t.beginPath(), t.moveTo(e, r), t.arcTo(e + o, r, e + o, r + n, i), t.arcTo(e + o, r + n, e, r + n, i), t.arcTo(e, r + n, e, r, i), t.arcTo(e, r, e + o, r, i), t.closePath()
                ...
                var l, u = s.createCanvas(e, r).getContext("2d");
                if (!u) return o;
                u.drawImage(t, 0, 0);
                try {
                ...
                for (;
                  (n += 20) < l.data.length;) l.data[n] > 200 || l.data[n + 1] > 200 || l.data[n + 2] > 200 || (++a, i.r += l.data[n], i.g += l.data[n + 1], i.b += l.data[n + 2]);
                return i.r = ~~(i.r / a), i.g = ~~(i.g / a), i.b = ~~(i.b / a), i
              }, t._drawDot = function (t, e, r, o, n, i) {
                void 0 === n && (n = 0), void 0 === i && (i = 1), t.fillRect((e + n) * o, (r + n) * o, i * o, i * o)
              }, t._drawAlignProtector = function (t, e, r, o) {
                t.clearRect((e - 2) * o, (r - 2) * o, 5 * o, 5 * o), t.fillRect((e - 2) * o, (r - 2) * o, 5 * o, 5 * o)
              }, t._drawAlign = function (e, r, o, n, i, a, s, l) {
                void 0 === i && (i = 0), void 0 === a && (a = 1);
                var u = e.fillStyle;
                e.fillStyle = s, new Array(4).fill(0).map((function (s, l) {
                  t._drawDot(e, r - 2 + l, o - 2, n, i, a), t._drawDot(e, r + 2, o - 2 + l, n, i, a), t._drawDot(e, r + 2 - l, o + 2, n, i, a), t._drawDot(e, r - 2, o + 2 - l, n, i, a)
                })), t._drawDot(e, r, o, n, i, a), l || (e.fillStyle = "rgba(255, 255, 255, 0.6)", new Array(2).fill(0).map((function (s, l) {
                  t._drawDot(e, r - 1 + l, o - 1, n, i, a), t._drawDot(e, r + 1, o - 1 + l, n, i, a), t._drawDot(e, r + 1 - l, o + 1, n, i, a), t._drawDot(e, r - 1, o + 1 - l, n, i, a)
                }))), e.fillStyle = u
              }, t.prototype._draw = function () {
                var e, r, o, a, f, p, g, m, v, y, w, b, C, B, P, x, A, E, R;
                return n(this, void 0, void 0, (function () {
                  var n, k, D, T, _, L, M, S, I, O, N, Q, F, U, j, z, G, H, q, K, X, Y, J, Z, W, V, $, tt, et, rt, ot, nt, it, at, st, lt, ut, ht, ct, ft, dt, pt, gt, mt, vt, yt, wt, bt, Ct, Bt, Pt, xt, At, Et, Rt, kt, Dt, Tt, _t, Lt, Mt, St, It;
                  return i(this, (function (i) {
                    switch (i.label) {
                    case 0:
                      if (n = null === (e = this.qrCode) || void 0 === e ? void 0 : e.moduleCount, k = this.options.size, ((D = this.options.margin) < 0 || 2 * D >= k) && (D = 0), T = Math.ceil(D), _ = k - 2 * D, L = this.options.whiteMargin, M = this.options.backgroundDimming, S = Math.ceil(_ / n), O = (I = S * n) + 2 * T, N = s.createCanvas(O, O), Q = N.getContext("2d"), this._clear(), Q.save(), Q.translate(T, T), F = s.createCanvas(O, O), U = F.getContext("2d"), j = null, z = [], !this.options.gifBackground) return [3, 1];
                      if (G = l.parseGIF(this.options.gifBackground), j = G, z = l.decompressFrames(G, !0), this.options.autoColor) {
                        for (H = 0, q = 0, K = 0, X = 0, gt = 0; gt < z[0].colorTable.length; gt++)(Y = z[0].colorTable[gt])[0] > 200 || Y[1] > 200 || Y[2] > 200 || 0 === Y[0] && 0 === Y[1] && 0 === Y[2] || (X++, H += Y[0], q += Y[1], K += Y[2]);
                        H = ~~(H / X), q = ~~(q / X), K = ~~(K / X), this.options.colorDark = "rgb(" + H + "," + q + "," + K + ")"
                      }
                      return [3, 4];
                    case 1:
                      return this.options.backgroundImage ? [4, s.loadImage(this.options.backgroundImage)] : [3, 3];
                    case 2:
                      return J = i.sent(), this.options.autoColor && (Z = t._getAverageRGB(J), this.options.colorDark = "rgb(" + Z.r + "," + Z.g + "," + Z.b + ")"), U.drawImage(J, 0, 0, J.width, J.height, 0, 0, O, O), U.rect(0, 0, O, O), U.fillStyle = M, U.fill(), [3, 4];
                    case 3:
                      U.rect(0, 0, O, O), U.fillStyle = this.options.colorLight, U.fill(), i.label = 4;
                    case 4:
                      for (W = u.QRUtil.getPatternPosition(this.qrCode.typeNumber), V = (null === (o = null === (r = this.options.components) || void 0 === r ? void 0 : r.data) || void 0 === o ? void 0 : o.scale) || c, $ = .5 * (1 - V), tt = 0; tt < n; tt++)
                        for (et = 0; et < n; et++) {
                          for (rt = this.qrCode.isDark(tt, et), ot = 6 == tt && et >= 8 && et <= n - 8 || 6 == et && tt >= 8 && tt <= n - 8, nt = et < 8 && (tt < 8 || tt >= n - 8) || et >= n - 8 && tt < 8 || ot, gt = 1; gt < W.length - 1; gt++) nt = nt || tt >= W[gt] - 2 && tt <= W[gt] + 2 && et >= W[gt] - 2 && et <= W[gt] + 2;
                          it = et * S + (nt ? 0 : $ * S), at = tt * S + (nt ? 0 : $ * S), Q.strokeStyle = rt ? this.options.colorDark : this.options.colorLight, Q.lineWidth = .5, Q.fillStyle = rt ? this.options.colorDark : "rgba(255, 255, 255, 0.6)", 0 === W.length ? nt || Q.fillRect(it, at, (nt ? 1 : V) * S, (nt ? 1 : V) * S) : (st = et < n - 4 && et >= n - 4 - 5 && tt < n - 4 && tt >= n - 4 - 5, nt || st || Q.fillRect(it, at, (nt ? 1 : V) * S, (nt ? 1 : V) * S))
                        }
                      if (lt = W[W.length - 1], Q.fillStyle = "rgba(255, 255, 255, 0.6)", Q.fillRect(0, 0, 8 * S, 8 * S), Q.fillRect(0, (n - 8) * S, 8 * S, 8 * S), Q.fillRect((n - 8) * S, 0, 8 * S, 8 * S), (null === (f = null === (a = this.options.components) || void 0 === a ? void 0 : a.timing) || void 0 === f ? void 0 : f.protectors) && (Q.fillRect(8 * S, 6 * S, (n - 8 - 8) * S, S), Q.fillRect(6 * S, 8 * S, S, (n - 8 - 8) * S)), (null === (g = null === (p = this.options.components) || void 0 === p ? void 0 : p.cornerAlignment) || void 0 === g ? void 0 : g.protectors) && t._drawAlignProtector(Q, lt, lt, S), null === (v = null === (m = this.options.components) || void 0 === m ? void 0 : m.alignment) || void 0 === v ? void 0 : v.protectors)
                        for (gt = 0; gt < W.length; gt++)
                          for (mt = 0; mt < W.length; mt++) vt = W[mt], yt = W[gt], (6 !== vt || 6 !== yt && yt !== lt) && (6 !== yt || 6 !== vt && vt !== lt) && (vt === lt && yt === lt || t._drawAlignProtector(Q, vt, yt, S));
                      for (Q.fillStyle = this.options.colorDark, Q.fillRect(0, 0, 7 * S, S), Q.fillRect((n - 7) * S, 0, 7 * S, S), Q.fillRect(0, 6 * S, 7 * S, S), Q.fillRect((n - 7) * S, 6 * S, 7 * S, S), Q.fillRect(0, (n - 7) * S, 7 * S, S), Q.fillRect(0, (n - 7 + 6) * S, 7 * S, S), Q.fillRect(0, 0, S, 7 * S), Q.fillRect(6 * S, 0, S, 7 * S), Q.fillRect((n - 7) * S, 0, S, 7 * S), Q.fillRect((n - 7 + 6) * S, 0, S, 7 * S), Q.fillRect(0, (n - 7) * S, S, 7 * S), Q.fillRect(6 * S, (n - 7) * S, S, 7 * S), Q.fillRect(2 * S, 2 * S, 3 * S, 3 * S), Q.fillRect((n - 7 + 2) * S, 2 * S, 3 * S, 3 * S), Q.fillRect(2 * S, (n - 7 + 2) * S, 3 * S, 3 * S), ut = (null === (w = null === (y = this.options.components) || void 0 === y ? void 0 : y.timing) || void 0 === w ? void 0 : w.scale) || c, ht = .5 * (1 - ut), gt = 0; gt < n - 8; gt += 2) t._drawDot(Q, 8 + gt, 6, S, ht, ut), t._drawDot(Q, 6, 8 + gt, S, ht, ut);
                      for (ct = (null === (C = null === (b = this.options.components) || void 0 === b ? void 0 : b.cornerAlignment) || void 0 === C ? void 0 : C.scale) || c, ft = .5 * (1 - ct), t._drawAlign(Q, lt, lt, S, ft, ct, this.options.colorDark, (null === (P = null === (B = this.options.components) || void 0 === B ? void 0 : B.cornerAlignment) || void 0 === P ? void 0 : P.protectors) || !1), dt = (null === (A = null === (x = this.options.components) || void 0 === x ? void 0 : x.alignment) || void 0 === A ? void 0 : A.scale) || c, pt = .5 * (1 - dt), gt = 0; gt < W.length; gt++)
                        for (mt = 0; mt < W.length; mt++) vt = W[mt], yt = W[gt], (6 !== vt || 6 !== yt && yt !== lt) && (6 !== yt || 6 !== vt && vt !== lt) && (vt === lt && yt === lt || t._drawAlign(Q, vt, yt, S, pt, dt, this.options.colorDark, (null === (R = null === (E = this.options.components) || void 0 === E ? void 0 : E.alignment) || void 0 === R ? void 0 : R.protectors) || !1));
                      return L && (Q.fillStyle = "#FFFFFF", Q.fillRect(-T, -T, O, T), Q.fillRect(-T, I, O, T), Q.fillRect(I, -T, T, O), Q.fillRect(-T, -T, T, O)), this.options.logoImage ? [4, s.loadImage(this.options.logoImage)] : [3, 6];
                    case 5:
                      wt = i.sent(), bt = this.options.logoScale, Ct = this.options.logoMargin, Bt = this.options.logoCornerRadius, (bt <= 0 || bt >= 1) && (bt = .2), Ct < 0 && (Ct = 0), Bt < 0 && (Bt = 0), At = xt = .5 * (O - (Pt = I * bt)), Q.restore(), Q.fillStyle = "#FFFFFF", Q.save(), t._prepareRoundedCornerClip(Q, xt - Ct, At - Ct, Pt + 2 * Ct, Pt + 2 * Ct, Bt + Ct), Q.clip(), Et = Q.globalCompositeOperation, Q.globalCompositeOperation = "destination-out", Q.fill(), Q.globalCompositeOperation = Et, Q.restore(), Q.save(), t._prepareRoundedCornerClip(Q, xt, At, Pt, Pt, Bt), Q.clip(), Q.drawImage(wt, xt, At, Pt, Pt), Q.restore(), Q.save(), Q.translate(T, T), i.label = 6;
                    case 6:
                      if (j) {
                        if (z.forEach((function (t) {
                            Rt || ((Rt = new h.default(k, k)).setDelay(t.delay), Rt.setRepeat(0));
                            var e = t.dims,
                              r = e.width,
                              o = e.height;
                            kt || (kt = s.createCanvas(r, o), (Dt = kt.getContext("2d")).rect(0, 0, kt.width, kt.height), Dt.fillStyle = "#ffffff", Dt.fill()), Tt && Lt && r === Tt.width && o === Tt.height || (Tt = s.createCanvas(r, o), _t = Tt.getContext("2d"), Lt = _t.createImageData(r, o)), Lt.data.set(t.patch), _t.putImageData(Lt, 0, 0), Dt.drawImage(Tt, t.dims.left, t.dims.top);
                            var n = s.createCanvas(O, O),
                              i = n.getContext("2d");
                            i.drawImage(kt, 0, 0, O, O), i.rect(0, 0, O, O), i.fillStyle = M, i.fill(), i.drawImage(N, 0, 0, O, O);
                            var a = s.createCanvas(k, k),
                              l = a.getContext("2d");
                            l.drawImage(n, 0, 0, k, k), Rt.addFrame(l.getImageData(0, 0, a.width, a.height).data)
                          })), !Rt) throw new Error("No frames.");
                        return Rt.finish(), d(this.canvas) ? (Mt = Rt.stream().toFlattenUint8Array(), St = Mt.reduce((function (t, e) {
                          return t + String.fromCharCode(e)
                        }), ""), [2, Promise.resolve("data:image/gif;base64," + window.btoa(St))]) : [2, Promise.resolve(Buffer.from(Rt.stream().toFlattenUint8Array()))]
                      }
                      return U.drawImage(N, 0, 0, O, O), Q.drawImage(F, -T, -T, O, O), (It = s.createCanvas(k, k)).getContext("2d").drawImage(N, 0, 0, k, k), this.canvas = It, d(this.canvas) ? [2, Promise.resolve(this.canvas.toDataURL())] : [2, Promise.resolve(this.canvas.toBuffer())]
                    }
                  }))
                }))
              }, t.CorrectLevel = u.QRErrorCorrectLevel, t.defaultComponentOptions = {
                data: {
                  scale: 1
                },
                timing: {
        ...
        937: (t, e) => {
          ...
          Object.defineProperty(e, "__esModule", {
            value: !0
          }), e.QRMath = e.QRUtil = e.QRMaskPattern = e.QRErrorCorrectLevel = e.QRCodeModel = void 0;
          var o = function () {
              function t(t) {
                this.mode = i.MODE_8BIT_BYTE, this.parsedData = [], this.data = t;
                for (var e = [], r = 0, o = this.data.length; r < o; r++) {
                  var n = [],
                    a = this.data.charCodeAt(r);
                  a > 65536 ? (n[0] = 240 | (1835008 & a) >>> 18, n[1] = 128 | (258048 & a) >>> 12, n[2] = 128 | (4032 & a) >>> 6, n[3] = 128 | 63 & a) : a > 2048 ? (n[0] = 224 | (61440 & a) >>> 12, n[1] = 128 | (4032 & a) >>> 6, n[2] = 128 | 63 & a) : a > 128 ? (n[0] = 192 | (1984 & a) >>> 6, n[1] = 128 | 63 & a) : n[0] = a, e.push(n)
                }
            ...
            n = function () {
              function t(t, r) {
                void 0 === t && (t = -1), void 0 === r && (r = e.QRErrorCorrectLevel.L), this.moduleCount = 0, this.dataList = [], this.typeNumber = t, this.errorCorrectLevel = r, this.moduleCount = 0, this.dataList = []
              }
              return t.prototype.addData = function (t) {
                if (this.typeNumber <= 0) this.typeNumber = function (t, o) {
                  for (var n = 1, i = r(t), a = 0, s = c.length; a < s; a++) {
                    var l = 0;
                    switch (o) {
                  ...
                  if (! function (t, o, n) {
                      ...
                      return i <= s
                    }(this.typeNumber, t, this.errorCorrectLevel)) throw new Error("Data is too long for QR version: " + this.typeNumber)
                }
                var n = new o(t);
                ...
                if (Number.isInteger(this.maskPattern) && Object.values(e.QRMaskPattern).includes(this.maskPattern)) return this.maskPattern;
                ...
                for (var t = a.getPatternPosition(this.typeNumber), e = 0; e < t.length; e++)
                  for (var r = 0; r < t.length; r++) {
                    ...
                    if (null == this.modules[o][n])
                      for (var i = -2; i <= 2; i++)
                        for (var s = -2; s <= 2; s++) this.modules[o + i][n + s] = -2 == i || 2 == i || -2 == s || 2 == s || 0 == i && 0 == s
                  }
                  ...
                  for (6 == s && s--;;) {
                    for (var l = 0; l < 2; l++)
                      if (null == this.modules[o][s - l]) {
                        var u = !1;
                        i < t.length && (u = 1 == (t[i] >>> n & 1)), a.getMask(e, o, s - l) && (u = !u), this.modules[o][s - l] = u, -1 == --n && (i++, n = 7)
                ...
                for (var n = u.getRSBlocks(e, r), i = new h, s = 0; s < o.length; s++) {
                  var l = o[s];
                  i.put(l.mode, 4), i.put(l.getLength(), a.getLengthInBits(l.mode, e)), l.write(i)
                }
                var c = 0;
                ...
                for (; !(i.getLengthInBits() >= 8 * c || (i.put(t.PAD0, 8), i.getLengthInBits() >= 8 * c));) i.put(t.PAD1, 8);
                return t.createBytes(i, n)
              }, t.createBytes = function (t, e) {
                for (var r = 0, o = 0, n = 0, i = new Array(e.length), s = new Array(e.length), u = 0; u < e.length; u++) {
                  var h = e[u].dataCount,
                    c = e[u].totalCount - h;
                  o = Math.max(o, h), n = Math.max(n, c), i[u] = new Array(h);
                  for (var f = 0; f < i[u].length; f++) i[u][f] = 255 & t.buffer[f + r];
                  r += h;
                  var d = a.getErrorCorrectPolynomial(c),
                    p = new l(i[u], d.getLength() - 1).mod(d);
                  for (s[u] = new Array(d.getLength() - 1), f = 0; f < s[u].length; f++) {
                ...
                var v = new Array(m),
                  y = 0;
                for (f = 0; f < o; f++)
                  for (u = 0; u < e.length; u++) f < i[u].length && (v[y++] = i[u][f]);
                for (f = 0; f < n; f++)
                  for (u = 0; u < e.length; u++) f < s[u].length && (v[y++] = s[u][f]);
                return v
              }, t.PAD0 = 236, t.PAD1 = 17, t
            }();
          e.QRCodeModel = n, e.QRErrorCorrectLevel = {
            L: 1,
            M: 0,
            Q: 3,
            H: 2
          ...
          var a = function () {
            ...
            return t.getBCHTypeInfo = function (e) {
              ...
              for (var e = new l([1], 0), r = 0; r < t; r++) e = e.multiply(new l([1, s.gexp(r)], 0));
              return e
              ...
              for (var e = t.getModuleCount(), r = 0, o = 0; o < e; o++)
                for (var n = 0; n < e; n++) {
                  for (var i = 0, a = t.isDark(o, n), s = -1; s <= 1; s++)
                    if (!(o + s < 0 || e <= o + s))
                      for (var l = -1; l <= 1; l++) n + l < 0 || e <= n + l || 0 == s && 0 == l || a == t.isDark(o + s, n + l) && i++;
                  i > 5 && (r += 3 + i - 5)
                }
              for (o = 0; o < e - 1; o++)
                for (n = 0; n < e - 1; n++) {
              ...
              return r + Math.abs(100 * h / e / e - 50) / 5 * 10
                        ...
                        ], t.G15 = 1335, t.G18 = 7973, t.G15_MASK = 21522, t
          }();
          e.QRUtil = a;
          var s = function () {
            function t() {}
            ...
            }, t.EXP_TABLE = new Array(256), t.LOG_TABLE = new Array(256), t._constructor = function () {
              for (var e = 0; e < 8; e++) t.EXP_TABLE[e] = 1 << e;
              for (e = 8; e < 256; e++) t.EXP_TABLE[e] = t.EXP_TABLE[e - 4] ^ t.EXP_TABLE[e - 5] ^ t.EXP_TABLE[e - 6] ^ t.EXP_TABLE[e - 8];
          ...
          var l = function () {
              ...
              return t.prototype.get = function (t) {
                ...
                for (var r = new Array(this.getLength() + e.getLength() - 1), o = 0; o < this.getLength(); o++)
                  for (var n = 0; n < e.getLength(); n++) r[o + n] ^= s.gexp(s.glog(this.get(o)) + s.glog(e.get(n)));
                return new t(r, 0)
              }, t.prototype.mod = function (e) {
                if (this.getLength() - e.getLength() < 0) return this;
                for (var r = s.glog(this.get(0)) - s.glog(e.get(0)), o = new Array(this.getLength()), n = 0; n < this.getLength(); n++) o[n] = this.get(n);
                for (n = 0; n < e.getLength(); n++) o[n] ^= s.gexp(s.glog(e.get(n)) + r);
            ...
            u = function () {
              ...
              return t.getRSBlocks = function (e, r) {
                var o = t.getRsBlockTable(e, r);
                if (null == o) throw new Error("bad rs block @ typeNumber:" + e + "/errorCorrectLevel:" + r);
                for (var n = o.length / 3, i = [], a = 0; a < n; a++)
                  for (var s = o[3 * a + 0], l = o[3 * a + 1], u = o[3 * a + 2], h = 0; h < s; h++) i.push(new t(l, u));
                return i
        ...
        137: (t, e, r) => {
          ...
          i.prototype.newPage = function () {
            ...
            this.cursor >= i.pageSize && this.newPage(), this.pages[this.page][this.cursor++] = t
            ...
            for (var o = r || t.length, n = e || 0; n < o; n++) this.writeByte(t[n])
            ...
            for (var r = 0, o = 0; o < e; o++) {
              var n = this.findClosestRGB(255 & this.pixels[r++], 255 & this.pixels[r++], 255 & this.pixels[r++]);
            ...
            for (var u = 0; u < i; u++) {
              e && (l *= -1);
              for (var h = 1 == l ? 0 : a - 1, c = 1 == l ? a : 0; h !== c; h += l) {
                var f = 3 * (n = u * a + h),
                  d = s[f],
                  p = s[f + 1],
                  g = s[f + 2];
                f = this.findClosestRGB(d, p, g), this.usedEntry[f] = !0, this.indexedPixels[n] = f, f *= 3;
                for (var m = d - this.colorTab[f], v = p - this.colorTab[f + 1], y = g - this.colorTab[f + 2], w = 1 == l ? 0 : o.length - 1, b = 1 == l ? o.length : 0; w !== b; w += l) {
                  var C = o[w][1],
                    B = o[w][2];
                  if (C + h >= 0 && C + h < a && B + u >= 0 && B + u < i) {
                    var P = o[w][0];
                    f = n + C + B * a, s[f *= 3] = Math.max(0, Math.min(255, s[f] + m * P)), s[f + 1] = Math.max(0, Math.min(255, s[f + 1] + v * P)), s[f + 2] = Math.max(0, Math.min(255, s[f + 2] + y * P))
                  }
                }
              }
            }
            ...
            for (var n = 0, i = 16777216, a = this.colorTab.length, s = 0, l = 0; s < a; l++) {
            ...
            for (var r = this.image, o = 0, n = 0, i = 0; i < e; i++)
              for (var a = 0; a < t; a++) this.pixels[n++] = r[o++], this.pixels[n++] = r[o++], this.pixels[n++] = r[o++], o++
        ...
        970: t => {
          ...
          t.exports = function (t, o, n, i) {
            var a, s, l, u, h, c, f, d, p, g = Math.max(2, i),
            ...
            function k(t, e) {
              for (a &= r[w], w > 0 ? a |= t << w : a = t, w += p; w >= 8;) B(255 & a, e), a >>= 8, w -= 8;
              if ((b > l || C) && (C ? (l = E(p = u), C = !1) : (++p, l = 12 == p ? 4096 : E(p))), t == c) {
                for (; w > 0;) B(255 & a, e), a >>= 8, w -= 8;
                A(e)
              }
            }
            this.encode = function (r) {
              r.writeByte(g), f = t * o, d = 0,
                function (t, r) {
                  var o, n, i, a, f, d;
                  for (C = !1, l = E(p = u = t), c = 1 + (h = 1 << t - 1), b = h + 2, s = 0, a = R(), d = 0, o = e; o < 65536; o *= 2) ++d;
                  d = 8 - d, x(e), k(h, r);
                  t: for (; - 1 != (n = R());)
                    if (o = (n << 12) + a, v[i = n << d ^ a] !== o) {
                      ...
                      k(a, r), a = n, b < 4096 ? (y[i] = b++, v[i] = o) : P(r)
                    } else a = y[i];
                  k(a, r), k(c, r)
                }(g + 1, r), r.writeByte(0)
            }
        ...
        110: t => {
          ...
          t.exports = function (t, n) {
            ...
            function h(t, e, o, n, a) {
              i[e][0] -= t * (i[e][0] - o) / r, i[e][1] -= t * (i[e][1] - n) / r, i[e][2] -= t * (i[e][2] - a) / r
            }

            function c(t, r, n, a, s) {
              for (var l, h, c = Math.abs(r - t), f = Math.min(r + t, e), d = r + 1, p = r - 1, g = 1; d < f || p > c;) h = u[g++], d < f && ((l = i[d++])[0] -= h * (l[0] - n) / o, l[1] -= h * (l[1] - a) / o, l[2] -= h * (l[2] - s) / o), p > c && ((l = i[p--])[0] -= h * (l[0] - n) / o, l[1] -= h * (l[1] - a) / o, l[2] -= h * (l[2] - s) / o)
            }

            function f(t, r, o) {
              var n, a, u, h, c, f = ~(1 << 31),
                d = f,
                p = -1,
                g = p;
              for (n = 0; n < e; n++) a = i[n], (u = Math.abs(a[0] - t) + Math.abs(a[1] - r) + Math.abs(a[2] - o)) < f && (f = u, p = n), (h = u - (s[n] >> 12)) < d && (d = h, g = n), c = l[n] >> 10, l[n] -= c, s[n] += c << 10;
              return l[p] += 64, s[p] -= 65536, g
            }
            this.buildColormap = function () {
              ! function () {
                var t, r;
                for (i = [], a = new Int32Array(256), s = new Int32Array(e), l = new Int32Array(e), u = new Int32Array(32), t = 0; t < e; t++) r = (t << 12) / e, i[t] = new Float64Array([r, r, r, 0]), l[t] = 256, s[t] = 0
              }(),
              function () {
                var e, o, i, a, s, l, d = t.length,
                  p = 30 + (n - 1) / 3,
                  g = d / (3 * n),
                  m = ~~(g / 100),
                  v = r,
                  y = 2048,
                  w = y >> 6;
                for (w <= 1 && (w = 0), e = 0; e < w; e++) u[e] = v * (256 * (w * w - e * e) / (w * w));
                d < 1509 ? (n = 1, o = 3) : o = d % 499 != 0 ? 1497 : d % 491 != 0 ? 1473 : d % 487 != 0 ? 1461 : 1509;
                var b = 0;
                for (e = 0; e < g;)
                  if (h(v, l = f(i = (255 & t[b]) << 4, a = (255 & t[b + 1]) << 4, s = (255 & t[b + 2]) << 4), i, a, s), 0 !== w && c(w, l, i, a, s), (b += o) >= d && (b -= d), 0 === m && (m = 1), ++e % m == 0)
                    for (v -= v / p, (w = (y -= y / 30) >> 6) <= 1 && (w = 0), l = 0; l < w; l++) u[l] = v * (256 * (w * w - l * l) / (w * w))
              }(),
              function () {
                for (var t = 0; t < e; t++) i[t][0] >>= 4, i[t][1] >>= 4, i[t][2] >>= 4, i[t][3] = t
              }(),
              function () {
                var t, r, o, n, s, l, u = 0,
                  h = 0;
                for (t = 0; t < e; t++) {
                  for (s = t, l = (o = i[t])[1], r = t + 1; r < e; r++)(n = i[r])[1] < l && (s = r, l = n[1]);
                  if (n = i[s], t != s && (r = n[0], n[0] = o[0], o[0] = r, r = n[1], n[1] = o[1], o[1] = r, r = n[2], n[2] = o[2], o[2] = r, r = n[3], n[3] = o[3], o[3] = r), l != u) {
                    for (a[u] = h + t >> 1, r = u + 1; r < l; r++) a[r] = t;
                    u = l, h = t
                  }
                }
                for (a[u] = h + 255 >> 1, r = u + 1; r < 256; r++) a[r] = 255
              }()
              ...
              for (var n, s, l, u = 1e3, h = -1, c = a[r], f = c - 1; c < e || f >= 0;) c < e && ((l = (s = i[c])[1] - r) >= u ? c = e : (c++, l < 0 && (l = -l), (n = s[0] - t) < 0 && (n = -n), (l += n) < u && ((n = s[2] - o) < 0 && (n = -n), (l += n) < u && (u = l, h = s[3])))), f >= 0 && ((l = r - (s = i[f])[1]) >= u ? f = -1 : (f--, l < 0 && (l = -l), (n = s[0] - t) < 0 && (n = -n), (l += n) < u && ((n = s[2] - o) < 0 && (n = -n), (l += n) < u && (u = l, h = s[3]))));
              return h
            }
          }
        },
        952: (t, e, r) => {
          ...
          const a = t => {
            ...
            s = (t, e, r) => {
              if (!t.image) return void console.warn("gif frame does not have associated image.");
              const {
                image: o
              } = t, n = o.descriptor.width * o.descriptor.height;
              var i = ((t, e, r) => {
                const o = 4096,
                  n = r;
                ...
                const g = new Array(r),
                  ...
                  v = new Array(o),
                  y = new Array(4097);
                for (u = 1 + (a = 1 << (p = t)), i = a + 2, c = -1, s = (1 << (l = p + 1)) - 1, f = 0; f < a; f++) m[f] = 0, v[f] = f;
                var w, b, C, B, P, x;
                for (w = b = C = B = P = x = 0, d = 0; d < n;) {
                  if (0 === B) {
                    ...
                    if (f = w & s, w >>= l, b -= l, f > i || f == u) break;
                    if (f == a) {
                    ...
                    for (h = f, f == i && (y[B++] = C, f = c); f > a;) y[B++] = v[f], f = m[f];
                    C = 255 & v[f], y[B++] = C, i < o && (m[i] = c, v[i] = C, 0 == (++i & s) && i < o && (l++, s += i)), c = h
                  }
                  B--, g[P++] = y[B], d++
                }
                for (d = P; d < n; d++) g[d] = 0;
              ...
              o.descriptor.lct.interlaced && (i = ((t, e) => {
              ...
              return o.descriptor.lct && o.descriptor.lct.exists ? a.colorTable = o.lct : a.colorTable = e, t.gce && (a.delay = 10 * (t.gce.delay || 10), a.disposalType = t.gce.extras.disposal, t.gce.extras.transparentColorGiven && (a.transparentIndex = t.gce.transparentColorIndex)), r && (a.patch = (t => {
                ...
                for (var o = 0; o < e; o++) {
                  const e = 4 * o,
                    n = t.pixels[o],
                    i = t.colorTable[n];
                  r[e] = i[0], r[e + 1] = i[1], r[e + 2] = i[2], r[e + 3] = n !== t.transparentIndex ? 255 : 0
                }
                return r
              })(a)), a
            },
            l = (t, e) => t.frames.filter((t => t.image)).map((r => s(r, t.gct, e)))
        }
      },
      e = {};
